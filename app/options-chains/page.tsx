      ...
      <Layout>
        <div className="space-y-6">
          ...
          <div className="bg-[#0F0F12] rounded-xl p-8 border border-[#1F1F23] flex flex-col items-center justify-center">
            ...
            <h2 className="text-xl font-bold text-white mb-2">Options Chain Data</h2>
            <p className="text-gray-400 text-center max-w-md mb-6">
              View real-time options chain data, including strikes, premiums, implied volatility, and more.
            </p>
